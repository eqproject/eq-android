...
/**
 * Created by liufan on 2019/6/18.
 */
...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(EQApplication.getInstance() != null){
            if (toast == null) {
                toast = Toast.makeText(EQApplication.getInstance(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            toast.show();
    ...
    public static void showLongToast(String msg) {
        if(EQApplication.getInstance() != null) {
            if (toast == null) {
                toast = Toast.makeText(EQApplication.getInstance(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.show();
