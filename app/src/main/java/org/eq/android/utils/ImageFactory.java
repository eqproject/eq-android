...
public class ImageFactory {
     ...
     * @throws IOException
     */
    public static void compressAndGenImage(Bitmap image, String outPath, double maxSize)
            throws IOException {
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        // scale
        int options = 100;
     ...
     * @throws IOException
     */
    public static void compressAndGenImageAsPng(Bitmap image, String outPath)
            throws IOException {
        ByteArrayOutputStream os = new ByteArrayOutputStream();
    ...
    public static void compressAndGenImage(String imgPath, String outPath,
                                           double maxSize, boolean needsDelete) throws IOException {
